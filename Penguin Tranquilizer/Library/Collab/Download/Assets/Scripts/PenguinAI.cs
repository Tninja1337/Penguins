...
public class PenguinAI : MonoBehaviour
{
    ...
    public int awarenessArea = 15; //How far the penguin should detect the enemy
    ...
    float range = 20; //How far the penguin have to run to resume the usual activities
    float multiplier = 1;
    ...
    void Start()
    {
        ...
        SwitchAnimationState(currentState); //set animation
        SwitchAnimationState(currentState); //set animation
    }
    ...
    {
        //Animation control set animations to withg ai stats
        if (animator)
        {
